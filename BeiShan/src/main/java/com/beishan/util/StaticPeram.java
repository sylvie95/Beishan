...
public class StaticPeram {
	...
	// 替换成你的AK (产品密)
	final static String accessKeyId = "xxxxxxxxxxxxxd";// 你的accessKeyId,参考本文档步骤2
	final static String accessKeySecret = "SpZcxxxxxxxxxxxxxxxxxxxsS";// 你的accessKeySecret，参考本文档步骤2
	// 必填:短信签名-可在短信控制台中找到
